...
$posts = ['add', 'assign', 'create', 'contact', 'edit', 'login', 'manage', 'permissions', 'register', 'retrieve', 'retire', 'unarchive', 'relocate', 'fart', 'change','upload', 'destroy', 'update', 'swap', 'select', 'exit'];
$pp = $pages[$route[0]] ?? '';
