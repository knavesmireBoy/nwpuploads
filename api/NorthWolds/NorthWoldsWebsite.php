    ...
    public function checkLogin(string $uri): array
    {
       ...
       */
       ...
       //$default = ['Admin', 'Client Admin', 'Client', 'Manager', 'Browser'];
        $actions = ['uploader/load' => set(), 'uploader/upload' => set(), 'uploader/update' => set(1), 'uploader/nav' => set(), 'uploader/delete' => set(1), 'uploader/confirm' => set(1), 'uploader/destroy' => set(1)];
